...
class MainWindow(GCS_Ui.Ui_mainWindow, QMainWindow):
    def __init__(self):
        super(MainWindow, self).__init__()
        self.setupUi(self)

        # changing background color (from image)
        # self.centralwidget.setStyleSheet("background-image:url(\"background.png\"); background-position: center; ");

        # setting icon pictures
        self.temp_img.setPixmap(QPixmap("icons/temp.png"))
        self.pres_img.setPixmap(QPixmap("icons/pressure.png"))
        self.gps_img.setPixmap(QPixmap("icons/gps.png"))
